...
const en = {
  ...
  styles: [
    { name: 'Living · Contemporary Classic', blurb: 'Ivory linen, cane-back chairs and a faded blue-grey rug.', desc: 'Classic character created entirely with portable pieces: an ivory sofa, matching cane-back chairs, a stone-top table, slim console, plug-in lamp and layered textiles.', tags: ['Contemporary Classic', 'Cane-back chairs', 'Federation room'], img: styleImgs[0] },
    ...
    { name: 'Living · Luxe', blurb: 'Warm beige seating, honed stone and restrained brass accents.', desc: 'An ordinary Sydney family room elevated entirely with portable staging: a modular sofa, matching timber chairs, stone-top table, wool rug, floor lamp, artwork and an oak media unit.', tags: ['Luxe', 'Portable styling', 'Garden outlook'], img: styleImgs[2] },
    { name: 'Lounge · Elegant Salon', blurb: 'Panelled walls, arched windows and a marble fireplace.', desc: 'The original French salon returns: wall panelling, arched steel windows, a classical fireplace and curved bouclé chairs beneath a crystal chandelier.', tags: ['Elegant Salon', 'Arched windows', 'Marble fireplace'], img: styleImgs[3] },
    { name: 'Lounge · Organic Modern', blurb: 'An olive lounge chair beside a broad apartment bay window.', desc: 'A compact apartment reading corner with one textured chair, ottoman, walnut table, paper lamp and portable greenery — calm, practical and easy to install.', tags: ['Organic Modern', 'Apartment nook', 'Bay window'], img: styleImgs[4] },
    { name: 'Lounge · Reading Salon', blurb: 'Cane-back chairs and a faded rug around an original fireplace.', desc: 'A Federation front room styled with two matching portable cane chairs, a walnut table, wool rug, plug-in lamp, simple console and restrained botanical art.', tags: ['Reading Salon', 'Cane chairs', 'Federation fireplace'], img: styleImgs[5] },
    { name: 'Dining · Refined Walnut', blurb: 'A softly layered walnut setting in a grand heritage dining room.', desc: 'A luxurious French-inspired composition with a rounded walnut table, oval-backed upholstered chairs, floral wool rug, curved console, layered linen and restrained tableware.', tags: ['Refined Walnut', 'Curved silhouettes', 'Heritage dining'], img: styleImgs[6] },
    { name: 'Dining · Apartment Oak', blurb: 'A compact round oak table with breathing room in a bright apartment.', desc: 'A natural apartment setting with a properly proportioned round oak table, four paper-cord chairs, a muted sage rug and ordinary urban views.', tags: ['Apartment Oak', 'Round table', 'Four seats'], img: styleImgs[7] },
    { name: 'Dining · Travertine Modern', blurb: 'A rounded travertine table in a contemporary townhouse.', desc: 'A modern townhouse setting with a long bullnose travertine table, six olive upholstered chairs, a patterned rug and a curved walnut console beside the courtyard.', tags: ['Travertine Modern', 'Townhouse', 'Courtyard'], img: styleImgs[8] },
    { name: 'Kitchen · Manor', blurb: 'A navy island, brass lanterns and rattan bistro stools.', desc: 'The restored manor-scale kitchen combines white cabinetry, a generous navy island, brass lanterns, rattan seating and blue-and-white ceramics in bright garden light.', tags: ['Manor', 'Navy island', 'Brass lanterns'], img: styleImgs[9] },
    ...
    { name: 'Kitchen · Provincial Styling', blurb: 'Rattan stools, blue-and-white ceramics and fresh herbs.', desc: 'An existing modern kitchen given French Provincial warmth using only removable stools, linens, ceramics, timber boards, herbs and countertop accessories.', tags: ['Provincial Styling', 'Rattan stools', 'Blue ceramics'], img: styleImgs[11] },
    { name: 'Bedroom · Hotel Suite', blurb: 'A grand upholstered bed, layered linen and panoramic views.', desc: 'The restored French hotel-suite look uses a generous upholstered bed, symmetrical lighting, layered ivory bedding and a refined sitting corner against wide water views.', tags: ['Hotel Suite', 'Layered linen', 'Panoramic view'], img: styleImgs[12] },
    ...
    { name: 'Entryway · Classic Welcome', blurb: 'A walnut console, gilt mirror and dusty-blue vintage runner.', desc: 'A memorable French first impression created with a slim portable console, leaning gilt mirror, plug-in lamp, petite bench, ceramics, artwork and runner.', tags: ['Classic Welcome', 'Walnut console', 'Vintage runner'], img: styleImgs[16] },
    { name: 'Entryway · Foyer Luxe', blurb: 'A gilt mirror, walnut console and blue-grey Persian runner.', desc: 'A wide French foyer completes the progression from ordinary to grand, with a formal walnut console, antique gilt mirror, sculptural bench, crystal chandelier and a long view through the residence.', tags: ['Foyer Luxe', 'Gilt mirror', 'Grand arrival'], img: styleImgs[17] },
  ],
  services: {
    eyebrow: 'Services',
  ...
  contact: {
    ...
    submit: 'Send enquiry',
    thanks: 'Your email is ready',
    received: 'Review and send the prepared enquiry in your email app. If it did not open, email us directly below.',
    emailLabel: 'Email',
    officeLabel: 'Office',
    hoursLabel: 'Hours',
...
const zh: Dict = {
  ...
  styles: [
    { name: '客厅 · 现代经典', blurb: '象牙色亚麻、藤编靠背单椅与灰蓝复古地毯。', desc: '经典格调全部由可搬单品完成：象牙色沙发、成对藤编单椅、石材台面茶几、窄边桌、插电台灯与层叠织物。', tags: ['现代经典', '藤编单椅', 'Federation 客厅'], img: styleImgs[0] },
    ...
    { name: '客厅 · 奢华典藏', blurb: '温暖米色座椅、天然石材与克制黄铜细节。', desc: '普通悉尼家庭客厅完全依靠可搬软装提升质感：模块沙发、成对木框单椅、石材茶几、羊毛地毯、落地灯、艺术画与橡木电视柜。', tags: ['奢华典藏', '可搬软装', '后院景观'], img: styleImgs[2] },
    { name: '会客区 · 优雅沙龙', blurb: '护墙板、拱形窗与大理石壁炉。', desc: '恢复原来的法式沙龙：护墙板线条、拱形钢窗、古典壁炉与弧形羊羔绒单椅，水晶灯下安静而大气。', tags: ['优雅沙龙', '拱形窗', '大理石壁炉'], img: styleImgs[3] },
    { name: '会客区 · 自然有机', blurb: '公寓宽窗旁的橄榄色休闲椅。', desc: '紧凑公寓阅读角，仅用一张纹理单椅、脚凳、胡桃木边桌、纸艺落地灯与可搬绿植完成——安静、现实、易于进场。', tags: ['自然有机', '公寓阅读角', '宽景窗'], img: styleImgs[4] },
    { name: '会客区 · 阅读沙龙', blurb: '原有壁炉前的藤编靠背椅与复古地毯。', desc: 'Federation 老宅前厅以两张统一可搬藤编椅、胡桃木边桌、羊毛地毯、插电落地灯、简洁边桌与植物画完成布置。', tags: ['阅读沙龙', '藤编单椅', 'Federation 壁炉'], img: styleImgs[5] },
    { name: '餐厅 · 胡桃雅致', blurb: '豪华老宅餐厅中的柔和胡桃木布置。', desc: '以圆角胡桃木长桌、椭圆软包餐椅、花卉羊毛地毯、弧形边柜、层叠亚麻与克制餐具完成更豪华的法式氛围。', tags: ['胡桃雅致', '柔和曲线', '老宅餐厅'], img: styleImgs[6] },
    { name: '餐厅 · 公寓原木', blurb: '明亮公寓里留有舒适动线的原木圆桌。', desc: '以比例自然的圆形橡木桌、四张纸绳餐椅、鼠尾草绿圆毯与普通城市景观完成小巧温馨的公寓布置。', tags: ['公寓原木', '圆形餐桌', '四人座'], img: styleImgs[7] },
    { name: '餐厅 · 洞石现代', blurb: '现代 townhouse 中的圆角洞石长桌。', desc: '以圆角洞石长桌、六张橄榄灰软包餐椅、图案地毯和弧形胡桃木边柜，完成面向小庭院的现代布置。', tags: ['洞石现代', 'Townhouse', '庭院采光'], img: styleImgs[8] },
    { name: '厨房 · 庄园雅致', blurb: '海军蓝大岛台、黄铜灯笼与藤编吧椅。', desc: '恢复旧版庄园尺度厨房：白色橱柜、宽大海军蓝岛台、黄铜灯笼、藤编座椅与蓝白陶器沐浴在明亮花园光线中。', tags: ['庄园雅致', '海军蓝岛台', '黄铜灯笼'], img: styleImgs[9] },
    { name: '厨房 · 现代橡木', blurb: '木质岛台、石材台面与简洁摆台。', desc: '现代橡木厨房：石材台面的木质岛台与克制的台面布置——干净、温暖、随时可以下厨。', tags: ['现代橡木', '石材台面', '简洁摆台'], img: styleImgs[10] },
    { name: '厨房 · 乡村雅韵', blurb: '藤编吧椅、蓝白陶器与新鲜香草。', desc: '在现有现代厨房中，仅通过可移动吧椅、亚麻、陶器、木质砧板、香草与台面饰品营造法式乡村暖意。', tags: ['乡村雅韵', '藤编吧椅', '蓝白陶器'], img: styleImgs[11] },
    { name: '卧室 · 精品酒店套房', blurb: '宽大软包床、层叠亚麻与开阔景观。', desc: '恢复旧版法式酒店套房：宽大软包床、对称灯光、象牙色层叠床品与精致休闲角，共同衬托开阔水景。', tags: ['精品酒店', '层叠亚麻', '开阔景观'], img: styleImgs[12] },
    ...
    { name: '玄关 · 典雅迎宾', blurb: '胡桃木玄关桌、金框镜与灰蓝复古地毯。', desc: '由窄款可搬玄关桌、落地金框镜、插电台灯、小型换鞋凳、陶器、艺术画与地毯营造难忘的法式第一印象。', tags: ['典雅迎宾', '胡桃木玄关桌', '复古地毯'], img: styleImgs[16] },
    { name: '玄关 · 奢华迎宾', blurb: '金框镜、胡桃木玄关桌与灰蓝波斯地毯。', desc: '以开阔远景完成从普通到豪华的递进：正式胡桃木玄关桌、古董金框镜、造型换鞋凳、水晶吊灯与贯穿住宅的深远视线。', tags: ['奢华迎宾', '金框镜', '大宅迎宾'], img: styleImgs[17] },
  ],
  services: {
    eyebrow: '服务',
    title: '为每一次出售而布置',
  ...
  contact: {
    ...
    submit: '发送咨询',
    thanks: '咨询邮件已准备好',
    received: '请在打开的邮件应用中确认并发送。如果邮件应用没有打开，可直接使用下方邮箱联系我们。',
    emailLabel: '邮箱',
    officeLabel: '办公室',
    hoursLabel: '营业时间',
...
const zhHant: Dict = {
  ...
  styles: [
    { name: '客廳 · 現代經典', blurb: '象牙色亞麻、藤編靠背單椅與灰藍復古地毯。', desc: '經典格調全部由可搬單品完成：象牙色沙發、成對藤編單椅、石材檯面茶几、窄邊桌、插電檯燈與層疊織物。', tags: ['現代經典', '藤編單椅', 'Federation 客廳'], img: styleImgs[0] },
    ...
    { name: '客廳 · 奢華典藏', blurb: '溫暖米色座椅、天然石材與克制黃銅細節。', desc: '普通悉尼家庭客廳完全依靠可搬軟裝提升質感：模組沙發、成對木框單椅、石材茶几、羊毛地毯、落地燈、藝術畫與橡木電視櫃。', tags: ['奢華典藏', '可搬軟裝', '後院景觀'], img: styleImgs[2] },
    { name: '會客區 · 優雅沙龍', blurb: '護牆板、拱形窗與大理石壁爐。', desc: '恢復原來的法式沙龍：護牆板線條、拱形鋼窗、古典壁爐與弧形羊羔絨單椅，水晶燈下安靜而大氣。', tags: ['優雅沙龍', '拱形窗', '大理石壁爐'], img: styleImgs[3] },
    { name: '會客區 · 自然有機', blurb: '公寓寬窗旁的橄欖色休閒椅。', desc: '緊湊公寓閱讀角，僅用一張紋理單椅、腳凳、胡桃木邊桌、紙藝落地燈與可搬綠植完成——安靜、現實、易於進場。', tags: ['自然有機', '公寓閱讀角', '寬景窗'], img: styleImgs[4] },
    { name: '會客區 · 閱讀沙龍', blurb: '原有壁爐前的藤編靠背椅與復古地毯。', desc: 'Federation 老宅前廳以兩張統一可搬藤編椅、胡桃木邊桌、羊毛地毯、插電落地燈、簡潔邊桌與植物畫完成佈置。', tags: ['閱讀沙龍', '藤編單椅', 'Federation 壁爐'], img: styleImgs[5] },
    { name: '餐廳 · 胡桃雅致', blurb: '豪華老宅餐廳中的柔和胡桃木佈置。', desc: '以圓角胡桃木長桌、橢圓軟包餐椅、花卉羊毛地毯、弧形邊櫃、層疊亞麻與克制餐具完成更豪華的法式氛圍。', tags: ['胡桃雅致', '柔和曲線', '老宅餐廳'], img: styleImgs[6] },
    { name: '餐廳 · 公寓原木', blurb: '明亮公寓裡留有舒適動線的原木圓桌。', desc: '以比例自然的圓形橡木桌、四張紙繩餐椅、鼠尾草綠圓毯與普通城市景觀完成小巧溫馨的公寓佈置。', tags: ['公寓原木', '圓形餐桌', '四人座'], img: styleImgs[7] },
    { name: '餐廳 · 洞石現代', blurb: '現代 townhouse 中的圓角洞石長桌。', desc: '以圓角洞石長桌、六張橄欖灰軟包餐椅、圖案地毯和弧形胡桃木邊櫃，完成面向小庭院的現代佈置。', tags: ['洞石現代', 'Townhouse', '庭院採光'], img: styleImgs[8] },
    { name: '廚房 · 莊園雅致', blurb: '海軍藍大島台、黃銅燈籠與藤編吧椅。', desc: '恢復舊版莊園尺度廚房：白色櫥櫃、寬大海軍藍島台、黃銅燈籠、藤編座椅與藍白陶器沐浴在明亮花園光線中。', tags: ['莊園雅致', '海軍藍島台', '黃銅燈籠'], img: styleImgs[9] },
    { name: '廚房 · 現代橡木', blurb: '木質島台、石材檯面與簡潔擺台。', desc: '現代橡木廚房：石材檯面的木質島台與克制的檯面佈置——乾淨、溫暖、隨時可以下廚。', tags: ['現代橡木', '石材檯面', '簡潔擺台'], img: styleImgs[10] },
    { name: '廚房 · 鄉村雅韻', blurb: '藤編吧椅、藍白陶器與新鮮香草。', desc: '在現有現代廚房中，僅透過可移動吧椅、亞麻、陶器、木質砧板、香草與檯面飾品營造法式鄉村暖意。', tags: ['鄉村雅韻', '藤編吧椅', '藍白陶器'], img: styleImgs[11] },
    { name: '臥室 · 精品飯店套房', blurb: '寬大軟包床、層疊亞麻與開闊景觀。', desc: '恢復舊版法式飯店套房：寬大軟包床、對稱燈光、象牙色層疊床品與精緻休閒角，共同襯托開闊水景。', tags: ['精品飯店', '層疊亞麻', '開闊景觀'], img: styleImgs[12] },
    ...
    { name: '玄關 · 典雅迎賓', blurb: '胡桃木玄關桌、金框鏡與灰藍復古地毯。', desc: '由窄款可搬玄關桌、落地金框鏡、插電檯燈、小型換鞋凳、陶器、藝術畫與地毯營造難忘的法式第一印象。', tags: ['典雅迎賓', '胡桃木玄關桌', '復古地毯'], img: styleImgs[16] },
    { name: '玄關 · 奢華迎賓', blurb: '金框鏡、胡桃木玄關桌與灰藍波斯地毯。', desc: '以開闊遠景完成從普通到豪華的遞進：正式胡桃木玄關桌、古董金框鏡、造型換鞋凳、水晶吊燈與貫穿住宅的深遠視線。', tags: ['奢華迎賓', '金框鏡', '大宅迎賓'], img: styleImgs[17] },
  ],
  services: {
    eyebrow: '服務',
    title: '為每一次出售而佈置',
  ...
  contact: {
    ...
    submit: '送出諮詢',
    thanks: '諮詢電郵已準備好',
    received: '請在開啟的電郵應用中確認並送出。如果電郵應用沒有開啟，可直接使用下方電郵聯絡我們。',
    emailLabel: '電郵',
    officeLabel: '辦公室',
    hoursLabel: '營業時間',
...
const ko: Dict = {
  ...
  styles: [
    { name: '거실 · 컨템퍼러리 클래식', blurb: '아이보리 리넨, 케인백 체어, 페이디드 블루그레이 러그.', desc: '아이보리 소파, 동일한 케인백 체어, 스톤 상판 테이블, 슬림 콘솔, 플러그인 램프와 텍스타일 등 이동 가능한 소품만으로 완성한 클래식 무드입니다.', tags: ['컨템퍼러리 클래식', '케인백 체어', '페더레이션 룸'], img: styleImgs[0] },
    ...
    { name: '거실 · 럭스', blurb: '웜 베이지 좌석, 천연 스톤과 절제된 브라스 포인트.', desc: '평범한 시드니 패밀리룸을 모듈 소파, 동일한 우드 프레임 체어, 스톤 테이블, 울 러그, 플로어 램프, 아트와 오크 TV장 등 이동 가능한 스타일링만으로 고급스럽게 완성했습니다.', tags: ['럭스', '이동식 스타일링', '가든 뷰'], img: styleImgs[2] },
    { name: '라운지 · 엘레강트 살롱', blurb: '패널 월, 아치 창, 마블 벽난로.', desc: '기존 프렌치 살롱을 복원했습니다. 월 패널링, 아치형 스틸 창, 클래식 벽난로와 커브드 부클레 체어가 크리스털 샹들리에 아래 놓입니다.', tags: ['엘레강트 살롱', '아치 창', '마블 벽난로'], img: styleImgs[3] },
    { name: '라운지 · 오가닉 모던', blurb: '넓은 아파트 베이 윈도 옆 올리브 라운지 체어.', desc: '텍스처 체어 하나, 오토만, 월넛 테이블, 페이퍼 램프와 이동식 식물로 완성한 실용적인 컴팩트 아파트 리딩 코너입니다.', tags: ['오가닉 모던', '아파트 누크', '베이 윈도'], img: styleImgs[4] },
    { name: '라운지 · 리딩 살롱', blurb: '기존 벽난로 앞 케인백 체어와 빈티지 러그.', desc: '페더레이션 전면실에 동일한 이동식 케인 체어 두 개, 월넛 테이블, 울 러그, 플러그인 램프, 심플 콘솔과 보태니컬 아트를 배치했습니다.', tags: ['리딩 살롱', '케인 체어', '페더레이션 벽난로'], img: styleImgs[5] },
    { name: '다이닝 · 리파인드 월넛', blurb: '고급 헤리티지 다이닝룸의 부드럽고 풍성한 월넛 스타일링.', desc: '라운드 월넛 테이블, 타원형 패브릭 의자, 플로럴 울 러그, 곡선 콘솔과 리넨 레이어로 한층 고급스러운 분위기를 완성했습니다.', tags: ['리파인드 월넛', '부드러운 곡선', '헤리티지 다이닝'], img: styleImgs[6] },
    { name: '다이닝 · 아파트 오크', blurb: '밝은 아파트에 여유 있게 놓인 내추럴 오크 원형 테이블.', desc: '자연스러운 비율의 원형 오크 테이블, 페이퍼 코드 의자 4개, 세이지 원형 러그와 실제 도심 전망으로 아늑하게 구성했습니다.', tags: ['아파트 오크', '원형 테이블', '4인용'], img: styleImgs[7] },
    { name: '다이닝 · 트래버틴 모던', blurb: '현대적인 타운하우스의 라운드 엣지 트래버틴 롱 테이블.', desc: '라운드 트래버틴 테이블, 올리브 그레이 의자 6개, 패턴 러그와 곡선 월넛 콘솔로 작은 중정을 향한 현대적인 다이닝을 완성했습니다.', tags: ['트래버틴 모던', '타운하우스', '코트야드'], img: styleImgs[8] },
    { name: '주방 · 매너', blurb: '네이비 대형 아일랜드, 브라스 랜턴, 라탄 비스트로 스툴.', desc: '복원한 매너 스케일 주방은 화이트 캐비닛, 넓은 네이비 아일랜드, 브라스 랜턴, 라탄 좌석과 블루앤화이트 도자기를 밝은 정원빛에 담았습니다.', tags: ['매너', '네이비 아일랜드', '브라스 랜턴'], img: styleImgs[9] },
    ...
    { name: '주방 · 프로빈셜 스타일링', blurb: '라탄 스툴, 블루앤화이트 도자기, 신선한 허브.', desc: '기존 모던 주방은 그대로 두고 이동식 스툴, 리넨, 도자기, 우드 보드, 허브와 벤치탑 소품만으로 프렌치 프로빈셜의 따뜻함을 더했습니다.', tags: ['프로빈셜 스타일링', '라탄 스툴', '블루 도자기'], img: styleImgs[11] },
    { name: '침실 · 호텔 스위트', blurb: '넉넉한 업홀스터드 베드, 레이어드 리넨과 파노라마 전망.', desc: '복원한 프렌치 호텔 스위트는 넉넉한 업홀스터드 베드, 대칭 조명, 아이보리 레이어드 베딩과 세련된 라운지 코너로 넓은 워터뷰를 강조합니다.', tags: ['호텔 스위트', '레이어드 리넨', '파노라마 전망'], img: styleImgs[12] },
    ...
    { name: '현관 · 클래식 웰컴', blurb: '월넛 콘솔, 길트 미러, 더스티 블루 빈티지 러너.', desc: '슬림한 이동식 콘솔, 기대어 둔 길트 미러, 플러그인 램프, 작은 벤치, 도자기, 아트와 러너로 완성한 프렌치 첫인상.', tags: ['클래식 웰컴', '월넛 콘솔', '빈티지 러너'], img: styleImgs[16] },
    { name: '현관 · 포이어 럭스', blurb: '길트 미러, 월넛 콘솔, 블루그레이 페르시안 러너.', desc: '넓은 원경으로 평범함에서 그랜드 프렌치까지의 흐름을 완성합니다. 포멀한 월넛 콘솔, 앤티크 길트 미러, 조형 벤치, 크리스털 샹들리에와 깊은 복도 전망을 담았습니다.', tags: ['포이어 럭스', '길트 미러', '그랜드 웰컴'], img: styleImgs[17] },
  ],
  services: {
    eyebrow: '서비스',
  ...
  contact: {
    ...
    submit: '문의 보내기',
    thanks: '문의 이메일이 준비되었습니다',
    received: '이메일 앱에서 내용을 확인한 후 보내 주세요. 앱이 열리지 않으면 아래 이메일로 직접 문의해 주세요.',
    emailLabel: '이메일',
    officeLabel: '오피스',
    hoursLabel: '운영 시간',

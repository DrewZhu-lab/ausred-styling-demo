...
const en = {
  ...
  styles: [
    ...
    { name: 'Dining · Refined Walnut', blurb: 'An eight-seat walnut setting overlooking an everyday suburban backyard.', desc: 'A practical formal setting built entirely from rental inventory: one walnut extension table, eight matching upholstered chairs, a wool rug, restrained tableware and a portable console.', tags: ['Refined Walnut', 'Eight-seat setting', 'Garden outlook'], img: styleImgs[6] },
    { name: 'Dining · Apartment Oak', blurb: 'A practical four-seat oak setting in a compact apartment.', desc: 'A simple apartment transformation using one pale oak table, four matching chairs, a runner and lightly styled tableware beside an ordinary urban balcony.', tags: ['Apartment Oak', 'Four-seat setting', 'Urban balcony'], img: styleImgs[7] },
    { name: 'Dining · Federation Warmth', blurb: 'A six-seat oval walnut table in an original Federation room.', desc: 'A relaxed setting assembled from a portable oval table, six bentwood chairs, a faded rug, freestanding sideboard and deliberately restrained tableware.', tags: ['Federation Warmth', 'Bentwood chairs', 'Original floorboards'], img: styleImgs[8] },
...
const zh: Dict = {
  ...
  styles: [
    ...
    { name: '餐厅 · 胡桃雅致', blurb: '面向普通住宅后院的八人胡桃木餐桌。', desc: '全部使用可租赁软装完成正式布置：胡桃木延伸餐桌、八张统一软包餐椅、羊毛地毯、克制餐具与可搬玄关桌。', tags: ['胡桃雅致', '八人餐桌', '后院采光'], img: styleImgs[6] },
    { name: '餐厅 · 公寓橡木', blurb: '紧凑公寓里的实用四人橡木餐桌。', desc: '以浅橡木餐桌、四张统一餐椅、桌旗和少量餐具完成简单布置，窗外保留普通城市阳台与邻楼。', tags: ['公寓橡木', '四人餐桌', '城市阳台'], img: styleImgs[7] },
    { name: '餐厅 · 老宅暖意', blurb: 'Federation 老宅中的六人椭圆胡桃木餐桌。', desc: '以可搬椭圆餐桌、六张 bentwood 餐椅、复古地毯、独立边柜与刻意留白的餐具完成松弛布置。', tags: ['老宅暖意', 'Bentwood 餐椅', '原木地板'], img: styleImgs[8] },
...
const zhHant: Dict = {
  ...
  styles: [
    ...
    { name: '餐廳 · 胡桃雅致', blurb: '面向普通住宅後院的八人胡桃木餐桌。', desc: '全部使用可租賃軟裝完成正式佈置：胡桃木延伸餐桌、八張統一軟包餐椅、羊毛地毯、克制餐具與可搬玄關桌。', tags: ['胡桃雅致', '八人餐桌', '後院採光'], img: styleImgs[6] },
    { name: '餐廳 · 公寓橡木', blurb: '緊湊公寓裡的實用四人橡木餐桌。', desc: '以淺橡木餐桌、四張統一餐椅、桌旗和少量餐具完成簡單佈置，窗外保留普通城市陽台與鄰樓。', tags: ['公寓橡木', '四人餐桌', '城市陽台'], img: styleImgs[7] },
    { name: '餐廳 · 老宅暖意', blurb: 'Federation 老宅中的六人橢圓胡桃木餐桌。', desc: '以可搬橢圓餐桌、六張 bentwood 餐椅、復古地毯、獨立邊櫃與刻意留白的餐具完成鬆弛佈置。', tags: ['老宅暖意', 'Bentwood 餐椅', '原木地板'], img: styleImgs[8] },
...
const ko: Dict = {
  ...
  styles: [
    ...
    { name: '다이닝 · 월넛 클래식', blurb: '일반적인 교외 정원을 바라보는 8인용 월넛 다이닝 세트.', desc: '월넛 확장 테이블, 동일한 패브릭 의자 8개, 울 러그, 절제된 테이블웨어와 이동식 콘솔 등 대여 가능한 품목만으로 완성했습니다.', tags: ['월넛 클래식', '8인 테이블', '정원 전망'], img: styleImgs[6] },
    { name: '다이닝 · 아파트 오크', blurb: '아담한 아파트의 실용적인 4인용 오크 다이닝 세트.', desc: '페일 오크 테이블, 동일한 의자 4개, 러너와 소량의 테이블웨어로 꾸미고 창밖에는 실제 도심 발코니와 이웃 건물을 남겼습니다.', tags: ['아파트 오크', '4인 테이블', '도심 발코니'], img: styleImgs[7] },
    { name: '다이닝 · 페더레이션 웜스', blurb: '오리지널 페더레이션 룸의 6인용 타원형 월넛 테이블.', desc: '이동식 타원형 테이블, 벤트우드 의자 6개, 빈티지 러그, 독립형 사이드보드와 절제된 테이블웨어로 편안하게 구성했습니다.', tags: ['페더레이션 웜스', '벤트우드 의자', '오리지널 마루'], img: styleImgs[8] },

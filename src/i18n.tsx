...
const en = {
  ...
  styles: [
    ...
    { name: 'Lounge · French Reading Salon', blurb: 'Cane-back chairs and a faded rug around an original fireplace.', desc: 'A Federation front room styled with two matching portable cane chairs, a walnut table, wool rug, plug-in lamp, simple console and restrained botanical art.', tags: ['French Salon', 'Cane chairs', 'Federation fireplace'], img: styleImgs[5] },
    { name: 'Dining · French Grandeur', blurb: 'An eight-seat walnut table in a bright Federation dining room.', desc: 'A restrained French-inspired setting built from practical rental inventory: one walnut table, eight matching upholstered chairs, a wool rug, simple tableware and a portable console.', tags: ['French Grandeur', 'Eight-seat setting', 'Federation room'], img: styleImgs[6] },
...
const zh: Dict = {
  ...
  styles: [
    ...
    { name: '会客区 · 法式阅读沙龙', blurb: '原有壁炉前的藤编靠背椅与复古地毯。', desc: 'Federation 老宅前厅以两张统一可搬藤编椅、胡桃木边桌、羊毛地毯、插电落地灯、简洁边桌与植物画完成布置。', tags: ['法式沙龙', '藤编单椅', 'Federation 壁炉'], img: styleImgs[5] },
    { name: '餐厅 · 法式盛宴', blurb: '明亮 Federation 老宅中的八人胡桃木餐桌。', desc: '以现实可租赁的单品完成克制法式布置：一张胡桃木餐桌、八张统一软包餐椅、羊毛地毯、简洁餐具与可搬边桌。', tags: ['法式盛宴', '八人摆台', 'Federation 老宅'], img: styleImgs[6] },
...
const zhHant: Dict = {
  ...
  styles: [
    ...
    { name: '會客區 · 法式閱讀沙龍', blurb: '原有壁爐前的藤編靠背椅與復古地毯。', desc: 'Federation 老宅前廳以兩張統一可搬藤編椅、胡桃木邊桌、羊毛地毯、插電落地燈、簡潔邊桌與植物畫完成佈置。', tags: ['法式沙龍', '藤編單椅', 'Federation 壁爐'], img: styleImgs[5] },
    { name: '餐廳 · 法式盛宴', blurb: '明亮 Federation 老宅中的八人胡桃木餐桌。', desc: '以現實可租賃的單品完成克制法式佈置：一張胡桃木餐桌、八張統一軟包餐椅、羊毛地毯、簡潔餐具與可搬邊桌。', tags: ['法式盛宴', '八人擺台', 'Federation 老宅'], img: styleImgs[6] },
...
const ko: Dict = {
  ...
  styles: [
    ...
    { name: '라운지 · 프렌치 리딩 살롱', blurb: '기존 벽난로 앞 케인백 체어와 빈티지 러그.', desc: '페더레이션 전면실에 동일한 이동식 케인 체어 두 개, 월넛 테이블, 울 러그, 플러그인 램프, 심플 콘솔과 보태니컬 아트를 배치했습니다.', tags: ['프렌치 살롱', '케인 체어', '페더레이션 벽난로'], img: styleImgs[5] },
    { name: '다이닝 · 프렌치 그랜저', blurb: '밝은 페더레이션 다이닝룸의 8인용 월넛 테이블.', desc: '월넛 테이블 하나, 동일한 패브릭 의자 8개, 울 러그, 간결한 테이블웨어와 이동식 콘솔 등 실제 대여 가능한 품목으로 완성한 절제된 프렌치 스타일입니다.', tags: ['프렌치 그랜저', '8인 세팅', '페더레이션 룸'], img: styleImgs[6] },

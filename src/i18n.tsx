...
const en = {
  ...
  styles: [
    ...
    { name: 'Dining · Grandeur', blurb: 'An eight-seat walnut table in a bright Federation dining room.', desc: 'A restrained French-inspired setting built from practical rental inventory: one walnut table, eight matching upholstered chairs, a wool rug, simple tableware and a portable console.', tags: ['Grandeur', 'Eight-seat setting', 'Federation room'], img: styleImgs[6] },
    ...
    { name: 'Dining · Bistro', blurb: 'An oval walnut table, cane chairs and relaxed linen layers.', desc: 'A warm French bistro setting for six, composed with a portable oval table, cane-back chairs, antique sideboard, faded rug and simple brass table accents.', tags: ['Bistro', 'Cane chairs', 'Relaxed table'], img: styleImgs[8] },
...
const zh: Dict = {
  ...
  styles: [
    ...
    { name: '餐厅 · 典雅盛宴', blurb: '明亮 Federation 老宅中的八人胡桃木餐桌。', desc: '以现实可租赁的单品完成克制法式布置：一张胡桃木餐桌、八张统一软包餐椅、羊毛地毯、简洁餐具与可搬边桌。', tags: ['典雅盛宴', '八人摆台', 'Federation 老宅'], img: styleImgs[6] },
    { name: '餐厅 · 北欧橡木', blurb: '亚麻吊灯下的浅橡木餐桌。', desc: '北欧式的简洁：浅橡木餐桌、软包餐椅与亚麻吊灯，花园采光洒满桌面——清新、亲切、适合家庭。', tags: ['北欧橡木', '亚麻吊灯', '花园采光'], img: styleImgs[7] },
    { name: '餐厅 · 温暖小馆', blurb: '椭圆胡桃木餐桌、藤编餐椅与松弛亚麻层次。', desc: '温暖的六人法式小馆布置，使用可搬椭圆餐桌、藤编靠背椅、古董感边柜、复古地毯与黄铜桌面饰品。', tags: ['温暖小馆', '藤编餐椅', '松弛摆台'], img: styleImgs[8] },
...
const zhHant: Dict = {
  ...
  styles: [
    ...
    { name: '餐廳 · 典雅盛宴', blurb: '明亮 Federation 老宅中的八人胡桃木餐桌。', desc: '以現實可租賃的單品完成克制法式佈置：一張胡桃木餐桌、八張統一軟包餐椅、羊毛地毯、簡潔餐具與可搬邊桌。', tags: ['典雅盛宴', '八人擺台', 'Federation 老宅'], img: styleImgs[6] },
    { name: '餐廳 · 北歐橡木', blurb: '亞麻吊燈下的淺橡木餐桌。', desc: '北歐式的簡潔：淺橡木餐桌、軟包餐椅與亞麻吊燈，花園採光灑滿桌面——清新、親切、適合家庭。', tags: ['北歐橡木', '亞麻吊燈', '花園採光'], img: styleImgs[7] },
    { name: '餐廳 · 溫暖小館', blurb: '橢圓胡桃木餐桌、藤編餐椅與鬆弛亞麻層次。', desc: '溫暖的六人法式小館佈置，使用可搬橢圓餐桌、藤編靠背椅、古董感邊櫃、復古地毯與黃銅桌面飾品。', tags: ['溫暖小館', '藤編餐椅', '鬆弛擺台'], img: styleImgs[8] },
...
const ko: Dict = {
  ...
  styles: [
    ...
    { name: '다이닝 · 그랜저', blurb: '밝은 페더레이션 다이닝룸의 8인용 월넛 테이블.', desc: '월넛 테이블 하나, 동일한 패브릭 의자 8개, 울 러그, 간결한 테이블웨어와 이동식 콘솔 등 실제 대여 가능한 품목으로 완성한 절제된 프렌치 스타일입니다.', tags: ['그랜저', '8인 세팅', '페더레이션 룸'], img: styleImgs[6] },
    ...
    { name: '다이닝 · 비스트로', blurb: '타원형 월넛 테이블, 케인 체어, 편안한 리넨 레이어.', desc: '이동 가능한 타원형 테이블, 케인백 체어, 앤티크 무드 사이드보드, 빈티지 러그와 브라스 테이블 소품으로 완성한 6인 프렌치 비스트로.', tags: ['비스트로', '케인 체어', '릴랙스드 테이블'], img: styleImgs[8] },

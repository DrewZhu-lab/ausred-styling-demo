...
const en = {
  ...
  styles: [
    ...
    { name: 'Living · Luxe', blurb: 'A grand marble salon with curved ivory seating and crystal light.', desc: 'Restored from the earlier French-luxe gallery: a wide formal living room with a double-height marble backdrop, curved ivory seating, brass tables and a cascading chandelier.', tags: ['Luxe', 'Grand salon', 'Crystal chandelier'], img: styleImgs[2] },
...
const zh: Dict = {
  ...
  styles: [
    { name: '客厅 · 现代经典', blurb: '象牙色亚麻、藤编靠背单椅与灰蓝复古地毯。', desc: '法式格调全部由可搬单品完成：象牙色沙发、藤编单椅、大理石台面茶几、落地金框镜、台灯与层叠织物。', tags: ['现代经典', '藤编单椅', '金框镜'], img: styleImgs[0] },
    ...
    { name: '客厅 · 奢华典藏', blurb: '大理石沙龙、弧形象牙色座椅与水晶灯光。', desc: '恢复旧版豪华法式案例：开阔正式客厅采用挑空大理石背景、弧形象牙色座椅、黄铜茶几与垂坠水晶吊灯。', tags: ['奢华典藏', '大宅沙龙', '水晶吊灯'], img: styleImgs[2] },
...
const zhHant: Dict = {
  ...
  styles: [
    { name: '客廳 · 現代經典', blurb: '象牙色亞麻、藤編靠背單椅與灰藍復古地毯。', desc: '法式格調全部由可搬單品完成：象牙色沙發、藤編單椅、大理石檯面茶几、落地金框鏡、落地燈與層疊織物。', tags: ['現代經典', '藤編單椅', '金框鏡'], img: styleImgs[0] },
    ...
    { name: '客廳 · 奢華典藏', blurb: '大理石沙龍、弧形象牙色座椅與水晶燈光。', desc: '恢復舊版豪華法式案例：開闊正式客廳採用挑空大理石背景、弧形象牙色座椅、黃銅茶几與垂墜水晶吊燈。', tags: ['奢華典藏', '大宅沙龍', '水晶吊燈'], img: styleImgs[2] },
...
const ko: Dict = {
  ...
  styles: [
    { name: '거실 · 컨템퍼러리 클래식', blurb: '아이보리 리넨, 케인백 체어, 페이디드 블루그레이 러그.', desc: '아이보리 소파, 케인백 체어, 대리석 상판 테이블, 기대어 둔 길트 미러, 플로어 램프와 텍스타일 등 이동 가능한 소품만으로 완성한 프렌치 무드.', tags: ['컨템퍼러리 클래식', '케인백 체어', '길트 미러'], img: styleImgs[0] },
    ...
    { name: '거실 · 럭스', blurb: '마블 살롱, 커브드 아이보리 좌석과 크리스털 조명.', desc: '이전 프렌치 럭스 갤러리를 복원했습니다. 복층 마블 배경, 커브드 아이보리 좌석, 브라스 테이블과 드라마틱한 크리스털 샹들리에가 넓은 거실을 완성합니다.', tags: ['럭스', '그랜드 살롱', '크리스털 샹들리에'], img: styleImgs[2] },

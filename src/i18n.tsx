...
const en = {
  ...
  styles: [
    ...
    { name: 'Living · Art Deco Bold', blurb: 'A warm beige cloud sofa, navy accents and gallery-scale art.', desc: 'A softer Art Deco composition: a warm oatmeal-beige cloud sofa, a single navy velvet accent chair, rust and ochre artwork, plus brass and glass details.', tags: ['Art Deco Bold', 'Beige cloud sofa', 'Navy accents'], img: styleImgs[2] },
    ...
    { name: 'Dining · Classic Grandeur', blurb: 'A formal table for ten beneath the chandelier.', desc: 'Coffered ceilings, a chandelier and a fully set ten-seat table framed by tall French doors — the formal dining statement.', tags: ['Classic Grandeur', 'Coffered ceiling', 'Formal setting'], img: styleImgs[6] },
    ...
    { name: 'Kitchen · Hamptons', blurb: 'A navy island under brass lanterns with rattan stools.', desc: 'A Hamptons heart-of-home: white shaker cabinetry, a navy island under brass lanterns and blue-and-white ceramics.', tags: ['Hamptons', 'Navy island', 'Brass lanterns'], img: styleImgs[9] },
...
const zh: Dict = {
  ...
  styles: [
    ...
    { name: '客厅 · 摩登撞色', blurb: '暖米色云朵沙发、海军蓝点缀与巨幅艺术画。', desc: '更柔和的摩登撞色：暖燕麦米色云朵沙发搭配单张海军蓝丝绒单椅、铁锈橘与赭石挂画，以及黄铜与玻璃细节。', tags: ['摩登撞色', '米色云朵沙发', '海军蓝点缀'], img: styleImgs[2] },
    ...
    { name: '餐厅 · 经典奢华', blurb: '枝形吊灯下的十人正式长桌。', desc: '藻井吊顶、枝形吊灯与十座正式摆台，高大的法式门框住花园绿意——大宅餐厅的气场。', tags: ['经典奢华', '藻井吊顶', '正式摆台'], img: styleImgs[6] },
    ...
    { name: '厨房 · 汉普顿', blurb: '海军蓝岛台、黄铜吊灯与藤编吧椅。', desc: '汉普顿式的家之心脏：白色 shaker 橱柜、黄铜灯笼下的海军蓝大岛台与青花瓷点缀。', tags: ['汉普顿', '海军蓝岛台', '黄铜灯笼'], img: styleImgs[9] },
...
const zhHant: Dict = {
  ...
  styles: [
    ...
    { name: '客廳 · 摩登撞色', blurb: '暖米色雲朵沙發、海軍藍點綴與巨幅藝術畫。', desc: '更柔和的摩登撞色：暖燕麥米色雲朵沙發搭配單張海軍藍絲絨單椅、鐵鏽橘與赭石掛畫，以及黃銅與玻璃細節。', tags: ['摩登撞色', '米色雲朵沙發', '海軍藍點綴'], img: styleImgs[2] },
    ...
    { name: '餐廳 · 經典奢華', blurb: '枝形吊燈下的十人正式長桌。', desc: '藻井天花、枝形吊燈與十座正式擺台，高大的法式門框住花園綠意——大宅餐廳的氣場。', tags: ['經典奢華', '藻井天花', '正式擺台'], img: styleImgs[6] },
    ...
    { name: '廚房 · 漢普頓', blurb: '海軍藍島台、黃銅吊燈與藤編吧椅。', desc: '漢普頓式的家之心臟：白色 shaker 櫥櫃、黃銅燈籠下的海軍藍大島台與青花瓷點綴。', tags: ['漢普頓', '海軍藍島台', '黃銅燈籠'], img: styleImgs[9] },
...
const ko: Dict = {
  ...
  styles: [
    ...
    { name: '거실 · 아트 데코 볼드', blurb: '따뜻한 베이지 클라우드 소파, 네이비 포인트와 대형 아트.', desc: '한층 부드러운 아트 데코 구성: 따뜻한 오트밀 베이지 클라우드 소파에 네이비 벨벳 암체어 하나, 러스트와 오커 아트, 브라스와 글라스 디테일을 더했습니다.', tags: ['아트 데코 볼드', '베이지 클라우드 소파', '네이비 포인트'], img: styleImgs[2] },
    ...
    { name: '다이닝 · 클래식 그랜저', blurb: '샹들리에 아래 10인 정찬 테이블.', desc: '우물천장과 샹들리에, 풀 세팅된 10인 테이블, 정원을 담은 프렌치 도어 — 대저택급 다이닝의 품격.', tags: ['클래식 그랜저', '우물천장', '정찬 세팅'], img: styleImgs[6] },
    ...
    { name: '주방 · 햄튼', blurb: '네이비 아일랜드, 브라스 랜턴, 라탄 스툴.', desc: '햄튼식 주방: 화이트 셰이커 캐비닛, 브라스 랜턴 아래 네이비 대형 아일랜드와 블루&화이트 도자기.', tags: ['햄튼', '네이비 아일랜드', '브라스 랜턴'], img: styleImgs[9] },

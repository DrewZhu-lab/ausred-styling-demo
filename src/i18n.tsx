...
const en = {
  ...
  styles: [
    ...
    { name: 'Lounge · French Elegance', blurb: 'Panelled walls, arched windows and a marble fireplace.', desc: 'A French salon mood: wall panelling, arched steel windows, a classical fireplace and curved bouclé chairs beneath a crystal chandelier.', tags: ['French Elegance', 'Arched windows', 'Marble fireplace'], img: styleImgs[2] },
    { name: 'Lounge · Organic Modern', blurb: 'A bouclé armchair, paper floor lamp and fiddle-leaf fig.', desc: 'A quiet reading corner in organic-modern style: bouclé curves, warm timber and greenery — calm, tactile, liveable.', tags: ['Organic Modern', 'Bouclé chair', 'Reading nook'], img: styleImgs[3] },
    { name: 'Dining · Classic Grandeur', blurb: 'A formal table for ten beneath the chandelier.', desc: 'Coffered ceilings, a chandelier and a fully set ten-seat table framed by tall French doors — the formal dining statement.', tags: ['Classic Grandeur', 'Coffered ceiling', 'Formal setting'], img: styleImgs[4] },
    { name: 'Dining · Scandi Oak', blurb: 'A pale oak table set beneath a linen pendant.', desc: 'Scandinavian simplicity: pale oak table, upholstered chairs and a linen pendant with garden light — fresh and family-friendly.', tags: ['Scandi Oak', 'Linen pendant', 'Garden light'], img: styleImgs[5] },
    { name: 'Kitchen · Hamptons', blurb: 'A navy island under brass lanterns with rattan stools.', desc: 'A Hamptons heart-of-home: white shaker cabinetry, a navy island under brass lanterns and blue-and-white ceramics.', tags: ['Hamptons', 'Navy island', 'Brass lanterns'], img: styleImgs[6] },
    { name: 'Kitchen · Modern Oak', blurb: 'A timber island, stone benchtop and styled boards.', desc: 'A modern oak kitchen: timber island with stone top and simple benchtop styling that reads clean and ready to cook in.', tags: ['Modern Oak', 'Stone benchtop', 'Styled benchtop'], img: styleImgs[7] },
    { name: 'Bedroom · Hotel Suite', blurb: 'A panelled bedhead wall and layered bedding with a view.', desc: 'A hotel-suite master: upholstered panel wall, layered bedding, symmetrical lamps and floor-to-ceiling water views.', tags: ['Hotel Suite', 'Panelled bedhead', 'Water views'], img: styleImgs[8] },
    { name: 'Bedroom · Soft Neutral', blurb: 'Layered linen bedding and warm artwork.', desc: 'A soft-neutral master: layered linen bedding, paired artworks and warm lamplight — the calm, broad-appeal bedroom.', tags: ['Soft Neutral', 'Linen layers', 'Paired art'], img: styleImgs[9] },
    { name: 'Bathroom · Resort Spa', blurb: 'A stone tub, timber-battened ceiling and private garden.', desc: 'Resort-spa calm: a sculptural stone tub beneath a timber-battened skylight and tropical greenery through full-height glass.', tags: ['Resort Spa', 'Stone tub', 'Garden outlook'], img: styleImgs[10] },
    { name: 'Bathroom · Stone Minimal', blurb: 'Travertine, an arched mirror and matte-black fittings.', desc: 'An urban stone bathroom: travertine surfaces, an arched mirror and matte-black tapware, styled with towels and greenery.', tags: ['Stone Minimal', 'Travertine', 'Matte black'], img: styleImgs[11] },
  ],
  services: {
    eyebrow: 'Services',
...
const zh: Dict = {
  ...
  styles: [
    ...
    { name: '会客区 · 法式优雅', blurb: '护墙板、拱形窗与大理石壁炉。', desc: '法式沙龙氛围：护墙板线条、拱形钢窗、古典壁炉与弧形羊羔绒单椅，水晶灯下安静而大气。', tags: ['法式优雅', '拱形窗', '大理石壁炉'], img: styleImgs[2] },
    { name: '会客区 · 自然有机', blurb: '羊羔绒单椅、纸艺落地灯与琴叶榕。', desc: '自然有机风的阅读角：羊羔绒曲线、温暖木质与绿植——安静、松弛、有生活的手感。', tags: ['自然有机', '羊羔绒单椅', '阅读角'], img: styleImgs[3] },
    { name: '餐厅 · 经典奢华', blurb: '枝形吊灯下的十人正式长桌。', desc: '藻井吊顶、枝形吊灯与十座正式摆台，高大的法式门框住花园绿意——大宅餐厅的气场。', tags: ['经典奢华', '藻井吊顶', '正式摆台'], img: styleImgs[4] },
    { name: '餐厅 · 北欧橡木', blurb: '亚麻吊灯下的浅橡木餐桌。', desc: '北欧式的简洁：浅橡木餐桌、软包餐椅与亚麻吊灯，花园采光洒满桌面——清新、亲切、适合家庭。', tags: ['北欧橡木', '亚麻吊灯', '花园采光'], img: styleImgs[5] },
    { name: '厨房 · 汉普顿', blurb: '海军蓝岛台、黄铜吊灯与藤编吧椅。', desc: '汉普顿式的家之心脏：白色 shaker 橱柜、黄铜灯笼下的海军蓝大岛台与青花瓷点缀。', tags: ['汉普顿', '海军蓝岛台', '黄铜灯笼'], img: styleImgs[6] },
    { name: '厨房 · 现代橡木', blurb: '木质岛台、石材台面与简洁摆台。', desc: '现代橡木厨房：石材台面的木质岛台与克制的台面布置——干净、温暖、随时可以下厨。', tags: ['现代橡木', '石材台面', '简洁摆台'], img: styleImgs[7] },
    { name: '卧室 · 精品酒店', blurb: '软包背景墙与层叠床品，窗外即水景。', desc: '酒店套房式主卧：软包板背景墙、层叠床品、对称台灯，落地窗外是开阔水景。', tags: ['酒店套房', '软包背景墙', '水景落地窗'], img: styleImgs[8] },
    { name: '卧室 · 柔和素色', blurb: '亚麻层叠床品与成对暖调挂画。', desc: '柔和素色主卧：亚麻层叠床品、成对挂画与暖光台灯——安静、耐看、接受度最广。', tags: ['柔和素色', '亚麻床品', '成对挂画'], img: styleImgs[9] },
    { name: '卫浴 · 度假水疗', blurb: '石质浴缸、木格栅顶与私属庭院。', desc: '度假酒店水疗般的松弛：木格栅天窗下的雕塑感石缸，整面玻璃引入热带绿意。', tags: ['度假水疗', '石质浴缸', '庭院绿意'], img: styleImgs[10] },
    { name: '卫浴 · 石材极简', blurb: '洞石、拱形镜与哑光黑五金。', desc: '都会感石材卫浴：洞石表面、拱形镜与哑光黑龙头，以毛巾与绿植做点睛。', tags: ['石材极简', '洞石', '哑光黑'], img: styleImgs[11] },
  ],
  services: {
    eyebrow: '服务',
    title: '为每一次出售而布置',
...
const zhHant: Dict = {
  ...
  styles: [
    ...
    { name: '會客區 · 法式優雅', blurb: '護牆板、拱形窗與大理石壁爐。', desc: '法式沙龍氛圍：護牆板線條、拱形鋼窗、古典壁爐與弧形羊羔絨單椅，水晶燈下安靜而大氣。', tags: ['法式優雅', '拱形窗', '大理石壁爐'], img: styleImgs[2] },
    { name: '會客區 · 自然有機', blurb: '羊羔絨單椅、紙藝落地燈與琴葉榕。', desc: '自然有機風的閱讀角：羊羔絨曲線、溫暖木質與綠植——安靜、鬆弛、有生活的手感。', tags: ['自然有機', '羊羔絨單椅', '閱讀角'], img: styleImgs[3] },
    { name: '餐廳 · 經典奢華', blurb: '枝形吊燈下的十人正式長桌。', desc: '藻井天花、枝形吊燈與十座正式擺台，高大的法式門框住花園綠意——大宅餐廳的氣場。', tags: ['經典奢華', '藻井天花', '正式擺台'], img: styleImgs[4] },
    { name: '餐廳 · 北歐橡木', blurb: '亞麻吊燈下的淺橡木餐桌。', desc: '北歐式的簡潔：淺橡木餐桌、軟包餐椅與亞麻吊燈，花園採光灑滿桌面——清新、親切、適合家庭。', tags: ['北歐橡木', '亞麻吊燈', '花園採光'], img: styleImgs[5] },
    { name: '廚房 · 漢普頓', blurb: '海軍藍島台、黃銅吊燈與藤編吧椅。', desc: '漢普頓式的家之心臟：白色 shaker 櫥櫃、黃銅燈籠下的海軍藍大島台與青花瓷點綴。', tags: ['漢普頓', '海軍藍島台', '黃銅燈籠'], img: styleImgs[6] },
    { name: '廚房 · 現代橡木', blurb: '木質島台、石材檯面與簡潔擺台。', desc: '現代橡木廚房：石材檯面的木質島台與克制的檯面佈置——乾淨、溫暖、隨時可以下廚。', tags: ['現代橡木', '石材檯面', '簡潔擺台'], img: styleImgs[7] },
    { name: '臥室 · 精品飯店', blurb: '軟包背景牆與層疊床品，窗外即水景。', desc: '飯店套房式主臥：軟包板背景牆、層疊床品、對稱檯燈，落地窗外是開闊水景。', tags: ['飯店套房', '軟包背景牆', '水景落地窗'], img: styleImgs[8] },
    { name: '臥室 · 柔和素色', blurb: '亞麻層疊床品與成對暖調掛畫。', desc: '柔和素色主臥：亞麻層疊床品、成對掛畫與暖光檯燈——安靜、耐看、接受度最廣。', tags: ['柔和素色', '亞麻床品', '成對掛畫'], img: styleImgs[9] },
    { name: '衛浴 · 度假水療', blurb: '石質浴缸、木格柵頂與私屬庭院。', desc: '度假飯店水療般的鬆弛：木格柵天窗下的雕塑感石缸，整面玻璃引入熱帶綠意。', tags: ['度假水療', '石質浴缸', '庭院綠意'], img: styleImgs[10] },
    { name: '衛浴 · 石材極簡', blurb: '洞石、拱形鏡與啞光黑五金。', desc: '都會感石材衛浴：洞石表面、拱形鏡與啞光黑龍頭，以毛巾與綠植做點睛。', tags: ['石材極簡', '洞石', '啞光黑'], img: styleImgs[11] },
  ],
  services: {
    eyebrow: '服務',
    title: '為每一次出售而佈置',
...
const ko: Dict = {
  ...
  styles: [
    ...
    { name: '라운지 · 프렌치 엘레강스', blurb: '패널 월, 아치 창, 마블 벽난로.', desc: '프렌치 살롱 무드: 월 패널링, 아치형 창, 클래식 벽난로와 커브드 부클레 체어 — 샹들리에 아래의 조용한 그랜저.', tags: ['프렌치 엘레강스', '아치 창', '마블 벽난로'], img: styleImgs[2] },
    { name: '라운지 · 오가닉 모던', blurb: '부클레 암체어, 페이퍼 램프, 휘커스 그린.', desc: '오가닉 모던 리딩 코너: 부클레 커브, 따뜻한 우드, 그린 — 조용하고 편안한 촉감의 공간.', tags: ['오가닉 모던', '부클레 체어', '리딩 누크'], img: styleImgs[3] },
    { name: '다이닝 · 클래식 그랜저', blurb: '샹들리에 아래 10인 정찬 테이블.', desc: '우물천장과 샹들리에, 풀 세팅된 10인 테이블, 정원을 담은 프렌치 도어 — 대저택급 다이닝의 품격.', tags: ['클래식 그랜저', '우물천장', '정찬 세팅'], img: styleImgs[4] },
    { name: '다이닝 · 스칸디 오크', blurb: '린넨 펜던트 아래 페일 오크 테이블.', desc: '스칸디나비아의 심플함: 페일 오크 테이블, 패브릭 의자, 린넨 펜던트와 정원 채광 — 산뜻하고 가족 친화적입니다.', tags: ['스칸디 오크', '린넨 펜던트', '정원 채광'], img: styleImgs[5] },
    { name: '주방 · 햄튼', blurb: '네이비 아일랜드, 브라스 랜턴, 라탄 스툴.', desc: '햄튼식 주방: 화이트 셰이커 캐비닛, 브라스 랜턴 아래 네이비 대형 아일랜드와 블루&화이트 도자기.', tags: ['햄튼', '네이비 아일랜드', '브라스 랜턴'], img: styleImgs[6] },
    { name: '주방 · 모던 오크', blurb: '우드 아일랜드, 스톤 벤치탑, 심플 스타일링.', desc: '모던 오크 주방: 스톤 상판의 우드 아일랜드와 절제된 벤치탑 스타일링 — 깨끗하고 따뜻한 공간.', tags: ['모던 오크', '스톤 벤치탑', '심플 스타일링'], img: styleImgs[7] },
    { name: '침실 · 호텔 스위트', blurb: '패널 헤드월과 레이어드 베딩, 워터뷰.', desc: '호텔 스위트 마스터룸: 패브릭 패널 월, 레이어드 베딩, 대칭 조명, 통유리 너머의 워터뷰.', tags: ['호텔 스위트', '패널 헤드월', '워터뷰'], img: styleImgs[8] },
    { name: '침실 · 소프트 뉴트럴', blurb: '린넨 레이어드 베딩과 웜 톤 아트 페어.', desc: '소프트 뉴트럴 마스터룸: 린넨 레이어드 베딩, 아트 페어와 따뜻한 램프 빛 — 차분하고 폭넓게 어필합니다.', tags: ['소프트 뉴트럴', '린넨 레이어', '아트 페어'], img: styleImgs[9] },
    { name: '욕실 · 리조트 스파', blurb: '스톤 욕조, 우드 루버 천장, 프라이빗 가든.', desc: '리조트 스파의 여유: 우드 루버 스카이라이트 아래 조각 같은 스톤 욕조, 통유리 가득한 열대 그린.', tags: ['리조트 스파', '스톤 욕조', '가든 뷰'], img: styleImgs[10] },
    { name: '욕실 · 스톤 미니멀', blurb: '트래버틴, 아치 미러, 매트 블랙 피팅.', desc: '어반 스톤 욕실: 트래버틴 표면, 아치 미러와 매트 블랙 수전, 타월과 그린으로 마무리.', tags: ['스톤 미니멀', '트래버틴', '매트 블랙'], img: styleImgs[11] },
  ],
  services: {
    eyebrow: '서비스',

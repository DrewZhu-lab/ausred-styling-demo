...
const en = {
  ...
  styles: [
    ...
    { name: 'Bedroom · Parisian Linen', blurb: 'Soft linen bedding, antique bedside tables and pleated lamps.', desc: 'A quiet Parisian-inspired bedroom assembled from a freestanding upholstered bed, walnut tables, plug-in lamps, gilt mirror, cane chair and faded floral rug.', tags: ['Parisian Linen', 'Antique tables', 'Plug-in lamps'], img: styleImgs[12] },
...
const zh: Dict = {
  ...
  styles: [
    ...
    { name: '客厅 · 法式现代', blurb: '象牙色亚麻、藤编靠背单椅与灰蓝复古地毯。', desc: '法式格调全部由可搬单品完成：象牙色沙发、藤编单椅、大理石台面茶几、落地金框镜、台灯与层叠织物。', tags: ['法式现代', '藤编单椅', '金框镜'], img: styleImgs[2] },
    { name: '会客区 · 法式阅读沙龙', blurb: '弧形羊羔绒单椅、胡桃木古董感家具与藕荷粉点缀。', desc: '紧凑法式阅读角，由可搬单椅、胡桃木展示柜、落地灯、落地金框镜、花卉地毯与收藏感饰品组成。', tags: ['法式沙龙', '胡桃木家具', '花卉地毯'], img: styleImgs[3] },
    ...
    { name: '餐厅 · 法式小馆', blurb: '椭圆胡桃木餐桌、藤编餐椅与松弛亚麻层次。', desc: '温暖的六人法式小馆布置，使用可搬椭圆餐桌、藤编靠背椅、古董感边柜、复古地毯与黄铜桌面饰品。', tags: ['法式小馆', '藤编餐椅', '松弛摆台'], img: styleImgs[6] },
    ...
    { name: '厨房 · 法式乡村软装', blurb: '藤编吧椅、蓝白陶器与新鲜香草。', desc: '在现有现代厨房中，仅通过可移动吧椅、亚麻、陶器、木质砧板、香草与台面饰品营造法式乡村暖意。', tags: ['法式乡村', '藤编吧椅', '蓝白陶器'], img: styleImgs[9] },
    ...
    { name: '卧室 · 巴黎亚麻', blurb: '柔和亚麻床品、古董感床头柜与百褶灯罩台灯。', desc: '安静的巴黎风卧室，由独立软包床、胡桃木床头柜、插电台灯、金框镜、藤编单椅与复古花卉地毯组成。', tags: ['巴黎亚麻', '古董感床头柜', '插电台灯'], img: styleImgs[12] },
...
const zhHant: Dict = {
  ...
  styles: [
    ...
    { name: '客廳 · 法式現代', blurb: '象牙色亞麻、藤編靠背單椅與灰藍復古地毯。', desc: '法式格調全部由可搬單品完成：象牙色沙發、藤編單椅、大理石檯面茶几、落地金框鏡、落地燈與層疊織物。', tags: ['法式現代', '藤編單椅', '金框鏡'], img: styleImgs[2] },
    { name: '會客區 · 法式閱讀沙龍', blurb: '弧形羊羔絨單椅、胡桃木古董感家具與藕荷粉點綴。', desc: '緊湊法式閱讀角，由可搬單椅、胡桃木展示櫃、落地燈、落地金框鏡、花卉地毯與收藏感飾品組成。', tags: ['法式沙龍', '胡桃木家具', '花卉地毯'], img: styleImgs[3] },
    ...
    { name: '餐廳 · 法式小館', blurb: '橢圓胡桃木餐桌、藤編餐椅與鬆弛亞麻層次。', desc: '溫暖的六人法式小館佈置，使用可搬橢圓餐桌、藤編靠背椅、古董感邊櫃、復古地毯與黃銅桌面飾品。', tags: ['法式小館', '藤編餐椅', '鬆弛擺台'], img: styleImgs[6] },
    ...
    { name: '廚房 · 法式鄉村軟裝', blurb: '藤編吧椅、藍白陶器與新鮮香草。', desc: '在現有現代廚房中，僅透過可移動吧椅、亞麻、陶器、木質砧板、香草與檯面飾品營造法式鄉村暖意。', tags: ['法式鄉村', '藤編吧椅', '藍白陶器'], img: styleImgs[9] },
    ...
    { name: '臥室 · 巴黎亞麻', blurb: '柔和亞麻床品、古董感床頭櫃與百褶燈罩檯燈。', desc: '安靜的巴黎風臥室，由獨立軟包床、胡桃木床頭櫃、插電檯燈、金框鏡、藤編單椅與復古花卉地毯組成。', tags: ['巴黎亞麻', '古董感床頭櫃', '插電檯燈'], img: styleImgs[12] },
...
const ko: Dict = {
  ...
  styles: [
    ...
    { name: '거실 · 프렌치 컨템퍼러리', blurb: '아이보리 리넨, 케인백 체어, 페이디드 블루그레이 러그.', desc: '아이보리 소파, 케인백 체어, 대리석 상판 테이블, 기대어 둔 길트 미러, 플로어 램프와 텍스타일 등 이동 가능한 소품만으로 완성한 프렌치 무드.', tags: ['프렌치 컨템퍼러리', '케인백 체어', '길트 미러'], img: styleImgs[2] },
    { name: '라운지 · 프렌치 리딩 살롱', blurb: '커브드 부클레 체어, 월넛 앤티크 무드, 더스티 로즈 포인트.', desc: '이동 가능한 체어, 월넛 장식장, 플로어 램프, 기대어 둔 길트 미러, 플로럴 러그와 소품으로 구성한 컴팩트 프렌치 리딩 살롱.', tags: ['프렌치 살롱', '월넛 가구', '플로럴 러그'], img: styleImgs[3] },
    ...
    { name: '다이닝 · 프렌치 비스트로', blurb: '타원형 월넛 테이블, 케인 체어, 편안한 리넨 레이어.', desc: '이동 가능한 타원형 테이블, 케인백 체어, 앤티크 무드 사이드보드, 빈티지 러그와 브라스 테이블 소품으로 완성한 6인 프렌치 비스트로.', tags: ['프렌치 비스트로', '케인 체어', '릴랙스드 테이블'], img: styleImgs[6] },
    ...
    { name: '주방 · 프렌치 프로빈셜 스타일링', blurb: '라탄 스툴, 블루앤화이트 도자기, 신선한 허브.', desc: '기존 모던 주방은 그대로 두고 이동식 스툴, 리넨, 도자기, 우드 보드, 허브와 벤치탑 소품만으로 프렌치 프로빈셜의 따뜻함을 더했습니다.', tags: ['프렌치 프로빈셜', '라탄 스툴', '블루 도자기'], img: styleImgs[9] },
    ...
    { name: '침실 · 파리지앵 리넨', blurb: '부드러운 리넨 베딩, 앤티크 무드 테이블, 플리츠 램프.', desc: '독립형 업홀스터드 베드, 월넛 테이블, 플러그인 램프, 길트 미러, 케인 체어와 페이디드 플로럴 러그로 완성한 차분한 파리지앵 침실.', tags: ['파리지앵 리넨', '앤티크 테이블', '플러그인 램프'], img: styleImgs[12] },

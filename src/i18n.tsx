...
const en = {
  ...
  styles: [
    ...
    { name: 'Lounge · Vintage Glam', blurb: 'Plum velvet, a leaning gilt mirror and a floral rug.', desc: 'Vintage glamour for a compact Art Deco apartment lounge: plum and dusty-rose velvet, a leaning gilt mirror, walnut storage and a muted floral rug.', tags: ['Vintage Glam', 'Apartment lounge', 'Gilt mirror'], img: styleImgs[5] },
    ...
    { name: 'Dining · Heritage Green', blurb: 'Deep green walls, olive velvet chairs and an oil painting.', desc: 'A heritage dining room: deep green walls, olive velvet chairs, claret drapes and a gallery-scale oil painting over herringbone parquet.', tags: ['Heritage Green', 'Olive velvet', 'Oil painting'], img: styleImgs[8] },
    ...
    { name: 'Kitchen · Provincial Blue', blurb: 'A powder-blue island with patterned pendants and rattan stools.', desc: 'French-provincial freshness: a powder-blue island, blue-and-white patterned pendants and rattan bistro stools in garden light.', tags: ['Provincial Blue', 'Powder-blue island', 'Bistro stools'], img: styleImgs[11] },
...
const zh: Dict = {
  ...
  styles: [
    ...
    { name: '会客区 · 复古格调', blurb: '梅子色丝绒、落地鎏金镜与花卉地毯。', desc: '紧凑 Art Deco 公寓会客厅的复古格调：梅子紫与藕荷色丝绒、倚放鎏金镜、胡桃木边柜与低饱和花卉地毯。', tags: ['复古格调', '公寓会客厅', '鎏金镜'], img: styleImgs[5] },
    ...
    { name: '餐厅 · 墨绿传承', blurb: '墨绿墙面、橄榄绒餐椅与巨幅油画。', desc: '传承感餐厅：墨绿墙面、橄榄色丝绒餐椅、酒红窗帘与人字拼地板上的巨幅油画。', tags: ['墨绿传承', '橄榄丝绒', '巨幅油画'], img: styleImgs[8] },
    ...
    { name: '厨房 · 普罗旺斯蓝', blurb: '粉蓝岛台、青花吊灯与藤编吧椅。', desc: '法式乡村的清新：粉蓝色岛台、青花图案吊灯与藤编小酒馆吧椅，花园光线洒满台面。', tags: ['普罗旺斯蓝', '粉蓝岛台', '藤编吧椅'], img: styleImgs[11] },
...
const zhHant: Dict = {
  ...
  styles: [
    ...
    { name: '會客區 · 復古格調', blurb: '梅子色絲絨、落地鎏金鏡與花卉地毯。', desc: '緊湊 Art Deco 公寓會客廳的復古格調：梅子紫與藕荷色絲絨、倚放鎏金鏡、胡桃木邊櫃與低飽和花卉地毯。', tags: ['復古格調', '公寓會客廳', '鎏金鏡'], img: styleImgs[5] },
    ...
    { name: '餐廳 · 墨綠傳承', blurb: '墨綠牆面、橄欖絨餐椅與巨幅油畫。', desc: '傳承感餐廳：墨綠牆面、橄欖色絲絨餐椅、酒紅窗簾與人字拼地板上的巨幅油畫。', tags: ['墨綠傳承', '橄欖絲絨', '巨幅油畫'], img: styleImgs[8] },
    ...
    { name: '廚房 · 普羅旺斯藍', blurb: '粉藍島台、青花吊燈與藤編吧椅。', desc: '法式鄉村的清新：粉藍色島台、青花圖案吊燈與藤編小酒館吧椅，花園光線灑滿檯面。', tags: ['普羅旺斯藍', '粉藍島台', '藤編吧椅'], img: styleImgs[11] },
...
const ko: Dict = {
  ...
  styles: [
    ...
    { name: '라운지 · 빈티지 글램', blurb: '플럼 벨벳, 기대어 둔 길트 미러와 플로럴 러그.', desc: '아담한 아르데코 아파트 라운지를 위한 빈티지 글램: 플럼과 더스티 로즈 벨벳, 기대어 둔 길트 미러, 월넛 수납장과 차분한 플로럴 러그.', tags: ['빈티지 글램', '아파트 라운지', '길트 미러'], img: styleImgs[5] },
    ...
    { name: '다이닝 · 헤리티지 그린', blurb: '딥 그린 월, 올리브 벨벳 체어, 대형 유화.', desc: '헤리티지 다이닝: 딥 그린 월, 올리브 벨벳 체어, 클라레 커튼과 헤링본 마루 위 대형 유화.', tags: ['헤리티지 그린', '올리브 벨벳', '대형 유화'], img: styleImgs[8] },
    ...
    { name: '주방 · 프로방스 블루', blurb: '파우더 블루 아일랜드와 패턴 펜던트, 라탄 스툴.', desc: '프렌치 프로빈셜의 산뜻함: 파우더 블루 아일랜드, 블루&화이트 패턴 펜던트와 라탄 비스트로 스툴.', tags: ['프로방스 블루', '블루 아일랜드', '비스트로 스툴'], img: styleImgs[11] },
